...
public class Bot2 extends Activity implements TextToSpeech.OnInitListener {
    ...
    static final String BUNDLE_KEY_NAME_FOR_MSG = Bot2.class.getName() + "_BUNDLE_KEY";
    private static final String LOG_TAG = Bot2.class.getSimpleName();
    ...
    private void startVoiceRecognitionActivity() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Speak to Bot2");
            ...
            case VOICE_RECOGNITION_REQUEST_CODE:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (0 <= k) {
                        ...
                        Log.i(LOG_TAG, "YQuote : " + ticker);
                        new YQuote(mHandler).execute(ticker);
                        mTV_STT.setText(s);
                    } else {
                        say(s);
                    }
